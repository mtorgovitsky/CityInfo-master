    ...
    public class PointsOfInterestController : Controller
    {
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            var maxPointOfInterestId = CitiesDataStore.Current.Cities.SelectMany(
                c => c.PointsOfInterest).Max(i => i.Id);
            ...
            [FromBody] JsonPatchDocument<PointOfInterestForUpdateDto> patchDoc)
        {
            ...
            var pointOfInterestFormStore = city.PointsOfInterest.FirstOrDefault(p => p.Id == id);
            ...
            pointOfInterestFormStore.Name = pointOfInterestToPatch.Name;
            pointOfInterestFormStore.Description = pointOfInterestToPatch.Description;
